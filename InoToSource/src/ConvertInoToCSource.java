...
public class ConvertInoToCSource {
	...
	public void CopyFileToCSource(List<String> prototypes) {
		...
		try {
			...
			System.out.println(
					"Error copiando prototipos de {0} - m\ufffdtodo CopyFileToCSource" + this.data.getSourceCode());
			System.out.println(e.getMessage());
		}
	}
